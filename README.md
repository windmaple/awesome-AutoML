...
- [neuropt](https://github.com/loevlie/neuropt): LLM-guided hyperparameter optimization and Neural Architecture Search — the LLM reads per-epoch training curves and designs the next experiment. 
